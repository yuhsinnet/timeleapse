...
ffmpeg -f concat -r 15 -i list.txt -s:v 1920x1080 -c:v libx264 -crf 35 -pix_fmt yuv420p C:\Users\x7870\Pictures\TimeLeapseVideo\camera1.avi

cd C:\Users\x7870\Pictures\TimeLeapsecam2
ffmpeg -f concat -r 15 -i list.txt -s:v 1920x1080 -c:v libx264 -crf 35 -pix_fmt yuv420p C:\Users\x7870\Pictures\TimeLeapseVideo\camera2.avi
